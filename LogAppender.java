/*
    LogAppender｜模拟日志生成器 v2.0 by Xander on 2020.2.24
    ...
    LogAppender v2.0 by Xander on June 24th, 2020
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while(current < totalLine) {
                ...
                System.out.printf("\n------------------------\n[Logv-ng] %d lines buffered, ready to append;\n########################\n", linesEachTime);
                System.out.print(buffer.toString());

                // append as a whole
                writer.write(buffer.toString(), 0, buffer.toString().length());
                writer.flush();
                System.out.printf("########################\n[Logv-ng] %d lines appended, going to sleep for %d seconds;\n------------------------\n", linesEachTime, interval);
